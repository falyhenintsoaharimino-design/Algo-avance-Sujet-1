...
Assemblage des trois parties précédentes dans un menu interactif, avec des tests automatiques pour vérifier que tout fonctionne ensemble.


## Mode de fonctionnement du script

Au démarrage, une série de tests automatiques s'exécute pour vérifier que le programme fonctionne correctement, puis un menu interactif s'affiche dans la console. Il suffit de taper le numéro de l'action voulue (afficher l'arbre, lancer un parcours, rechercher, ajouter ou supprimer un nœud, voir les statistiques) et de suivre les instructions à l'écran. Le programme reste actif jusqu'à ce que l'option "0. Quitter" soit choisie.
